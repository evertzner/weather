...
const Forecast = () => {
  ...
  function getDayName(dayStr, locale) {
        ...
        if (wf.dt_txt.substr(-8, 5) === '12:00') {
          ...
          return (
            <div className="forecast__day" key={wf.dt}>
              <div className="forecast__day__time">{getDayName(wf.dt_txt, 'en-US', index)}</div>
              <div className="forecast__day__pop">{Math.trunc(wf.pop * 100)}%</div>
              <img
